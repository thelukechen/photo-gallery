const API_URL = "https://deo5h63s60.execute-api.us-east-1.amazonaws.com/dev";
const PHOTOGALLERY_S3_BUCKET_URL = "photobucket-chen-2021-4150";
...
function processDeletePhoto(photoid, creationtime){
    var datadir = {
        PhotoID: photoid,
...
function processUpdatePhoto(photo){
    var title = $("#title").val();
    var description = $("#description").val();
    var tags = $("#tags").val();
...
$('#portfolio-4-col-grid').on('click', '#home_delete', function(e) {
    ...
    processDeletePhoto(`${$this.data('photoid')}`, $this.data('creationtime'))
...
$('#viewphoto-container').on('click', '#photo_update', function(e) {
    ...
    var $this = $(this);
    console.log(`PhotoID: ${$this.data('photo')}`);
    processUpdatePhoto(`${$this.data('photo')}`);
});
...
$('#viewphoto-container').on('click', '#photo_delete', function() {
    var $this = $(this);
    console.log("DELETING!!",  $(this).data('photo'))
    processDeletePhoto(`${$(this).data('photo')}`, $(this).data('photo'))
});
